 ...
 *           3. 서버 오류 반환
 */
const beforeMain = async (req: Request, res: Response<beforeMainResponseDto>) => {
    try {
 ...
 *           3. 서버 오류 반환
 */
const challengeSearch = async (req: Request<any, any, any, categorySearchRequestDto>, res: Response<challengeSearchResponseDto>) => {
    try {
 ...
 *           3. 서버 오류 반환
 */
const afterMain = async (req: Request, res: Response<afterMainResponseDto>) => {
    try {
